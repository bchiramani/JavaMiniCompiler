...
//Vérifier l’appel des procédures avec les bons arguments
...
// Vérifier qu’une variable utilisée est bien déclarée.
...
// Vérifier que les variables déclarées sont bien initialisées.
...
//  Vérifier qu’une variable déclarée est bien utilisée.
...
//Vérifier qu'une fonction qui retourne un type contient return
